...
//
extern const u8 g_picdata[];
extern const u8 g_TITLE[];
extern const u8 g_stage1[];
extern const u8 g_stage1_enemies[];
extern const u8 g_stage1_mugi[];
extern const u8 g_stage2[];
extern const u8 g_stage2_enemies[];
extern const u8 g_stage2_mugi[];
extern const u8 g_stage3[];
extern const u8 g_stage3_enemies[];
extern const u8 g_stage3_mugi[];
extern const u8 g_stage4[];
extern const u8 g_stage4_enemies[];
extern const u8 g_stage4_mugi[];
extern const u8 g_stage5[];
extern const u8 g_stage5_enemies[];
extern const u8 g_stage5_mugi[];
extern const u8 g_stage6[];
extern const u8 g_stage6_enemies[];
extern const u8 g_stage6_mugi[];
extern const u8 g_stage7[];
extern const u8 g_stage7_enemies[];
extern const u8 g_stage7_mugi[];
extern const u8 g_stage8[];
extern const u8 g_stage8_enemies[];    
extern const u8 g_stage8_mugi[];
extern const u8 g_stage9[];
extern const u8 g_stage9_enemies[];
extern const u8 g_stage9_mugi[];
extern const u8 g_stage10[];
extern const u8 g_stage10_enemies[];
extern const u8 g_stage10_mugi[];
extern const u8 g_stage11[];
extern const u8 g_stage11_enemies[];
extern const u8 g_stage11_mugi[];
extern const u8 g_stage12[];
extern const u8 g_stage12_enemies[];
extern const u8 g_stage12_mugi[];
extern const u8 g_stage13[];
extern const u8 g_stage13_enemies[];
extern const u8 g_stage13_mugi[];
extern const u8 g_stage14[];
extern const u8 g_stage14_enemies[];
extern const u8 g_stage14_mugi[];
extern const u8 g_stage15[];
extern const u8 g_stage15_enemies[];
extern const u8 g_stage15_mugi[];
extern const u8 g_stage16[];
extern const u8 g_stage16_enemies[];
extern const u8 g_stage16_mugi[];
extern const u8 g_stage17[];
extern const u8 g_stage17_enemies[];
extern const u8 g_stage17_mugi[];
extern const u8 g_stage18[];
extern const u8 g_stage18_enemies[];
extern const u8 g_stage18_mugi[];
extern const u8 g_stage19[];
extern const u8 g_stage19_enemies[];
extern const u8 g_stage19_mugi[];
extern const u8 g_stage20[];
extern const u8 g_stage20_enemies[];
extern const u8 g_stage20_mugi[];
extern const u8 g_stage21[];
extern const u8 g_stage21_enemies[];
extern const u8 g_stage21_mugi[];
extern const u8 g_stage22[];
extern const u8 g_stage22_enemies[];
extern const u8 g_stage22_mugi[];
extern const u8 g_stage23[];
extern const u8 g_stage23_enemies[];
extern const u8 g_stage23_mugi[];
extern const u8 g_stage24[];
extern const u8 g_stage24_enemies[];
extern const u8 g_stage24_mugi[];
extern const u8 g_stage25[];
extern const u8 g_stage25_enemies[];
extern const u8 g_stage25_mugi[];
extern const u8 g_stage26[];
extern const u8 g_stage26_enemies[];
extern const u8 g_stage26_mugi[];
extern const u8 g_stage27[];
extern const u8 g_stage27_enemies[];
extern const u8 g_stage27_mugi[];
extern const u8 g_stage28[];
extern const u8 g_stage28_enemies[];
extern const u8 g_stage28_mugi[];
extern const u8 g_stage29[];
extern const u8 g_stage29_enemies[];    
extern const u8 g_stage29_mugi[];
extern const u8 g_stage30[];
extern const u8 g_stage30_enemies[];
extern const u8 g_stage30_mugi[];



// SOUND
extern const u8 g_mugi_bgm[];
extern const u8 g_mugi_sfx[];
...
void display_stage_number() {
    ...
    // S_Printを使ってステージ番号を表示
    S_Print_Text(0, 10, 10, "STAGE");
    S_Print_Int(0, 16, 10, current_stage);
    //S_Print_Int(0, 16, 16, stage_display_timer); // 秒数表示
    stage_display_timer--;
...
void Helper_PletterUnpackToRAM(const u8* src, u8* dst) { Pletter_UnpackToRAM(src, dst); }
...
void Load_Picdata(u8 num){
    ...
    //　**VRAM直接読み込み処理に変更**
    // Tile_SetBankPage(0);
    // Pletter_UnpackToVRAM(g_picdata,(u16)Tile_GetBankAddress(0));
    // VDP_CommandHMMM(0,0,0,num*256,256,80);
    // Tile_SetBankPage(num);
}
...
void Game_Init(){
    ...
    Pletter_UnpackToRAM(g_mugi_sfx,0xE000);//効果音データ展開
    current_stage = 1;
...
void ui_update(){
    // スコア表示
    S_Print_Text(2,0,0,"SCORE");  
    S_Print_Int_Padded32(2,7,0,score,6,'0');

    // TIMER表示
    S_Print_Text(2,15,0,"TIME");  
    S_Print_Int_Padded(2,20,0,time,4,'0');

    // STAGExx表示
    S_Print_Text(2,15,1,"STAGE");  
    S_Print_Int_Padded(2,22,1,current_stage,2,'0');

    // ENERGY表示
    S_Print_Text(2,0,1,"ENERGY");
    S_Print_Int_Padded(2,10,1,energy,3,'0');

    // ページ２からページ０へコピー
	VDP_CommandHMMM(0,256*2,0,0,256,16);
}

void Stage_start(){
    const u8* g_stage_data;
    const u8* g_stage_mugi;
    const u8* g_stage_enemies;
    ...
    SW_Sprite_Set(0, mugi_x, mugi_y, 0);
...
void VDP_InterruptHandler()
{
    ...
    if(next_bgm != 0xFF){
        AKG_Play(next_bgm,0xD100);
        //if(next_se == 0xFF)AKG_InitSFX(0xE000);//効果音データ読み込み
        next_bgm = 0xFF;
    }
    if(next_se != 0xFF){
        if(sfx_loaded == 0){
            AKG_InitSFX(0xE000);//効果音データ読み込み
            sfx_loaded = 1;
        }
